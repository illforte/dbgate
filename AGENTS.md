...
- Canonical working branch for this fork is `premium-clean`; keep the `h0menode` first-stage preview aligned to that branch unless the repo strategy is explicitly changed.
